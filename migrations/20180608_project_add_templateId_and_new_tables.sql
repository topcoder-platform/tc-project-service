...
CREATE TABLE product_milestone_templates (
    ...
    type character varying(45) NOT NULL,
    "order" integer NOT NULL,
    "plannedText" character varying(255) NOT NULL,
    "activeText" character varying(255) NOT NULL,
    "blockedText" character varying(255) NOT NULL,
    "completedText" character varying(255) NOT NULL,
    "deletedAt" timestamp with time zone,
    "createdAt" timestamp with time zone,
    "updatedAt" timestamp with time zone,
    "deletedBy" bigint,
